export class Start extends Phaser.Scene {
    ...
    create() {
        ...
        const botonGuardar = this.add.text(700, 40, 'GUARDAR', {
            fontSize: '24px',
            fill: '#00ff00',
        ...
        .setOrigin(0.5)
        .setInteractive()
        .on('pointerover', () => botonGuardar.setStyle({ fill: '#ffffff' }))
        .on('pointerout', () => botonGuardar.setStyle({ fill: '#00ff00' }));

       
        botonGuardar.on('pointerdown', () => {
            console.log("Cambiando a GameChoice...");
